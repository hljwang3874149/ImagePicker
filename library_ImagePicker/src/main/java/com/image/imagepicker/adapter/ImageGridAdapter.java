package com.image.imagepicker.adapter;
...
public class ImageGridAdapter extends BaseAdapter {
        ...
        if (itemViewType == ITEM_TYPE_CAMERA) {
            ...
            convertView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if(listener != null){
                        listener.onCameraItemClick(ImagePicker.REQUEST_CODE_TAKE);
                    }
            ...
            holder.cbCheck.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (holder.cbCheck.isChecked() && mSelectedImages.size() >= selectLimit) {
                        Utils.showToast(mActivity , mActivity.getString(R.string.select_limit, selectLimit));
            ...
            imagePicker.getImageLoader().displayImage(mActivity, imageItem.path, holder.ivThumb); //显示图片
        }
        return convertView;
    }
    ...
    public interface OnImageItemClickListener {
        ...
        void onCameraItemClick(int code);
    }
}