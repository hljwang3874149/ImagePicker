...
public class ImageCropActivity extends BaseActivity implements View.OnClickListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (null != mBitmap) {
            ...
            Utils.showToast(this, R.string.image_original_not_found);
//            Toast.makeText(ImageCropActivity.this, R.string.image_original_not_found, Toast.LENGTH_SHORT).show();
            finish();
        }
//        mCropImageView.setImageURI(Uri.fromFile(new File(imagePath)));
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.btn_back) {
            ...
            mCropImageView.saveBitmapToFile(imagePicker.getCropCacheFolder(this), mOutputX,
...
//        Toast.makeText(ImageCropActivity.this, "裁剪成功:" + file.getAbsolutePath(), Toast
// .LENGTH_SHORT).show();
//        Log.e("ImageCropActivity" , "裁剪成功:" + file.getAbsolutePath() );
