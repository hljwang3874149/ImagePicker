...
import com.image.imagepicker.adapter.ImagePageAdapter;
import com.image.imagepicker.bean.ImageItem;
import com.image.imagepicker.view.SuperCheckBox;
import com.image.imagepicker.view.ViewPagerFixed;
        ...
        mCbCheck.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mCbCheck.isChecked() && selectedImages.size() >= selectLimit) {
                    Utils.showToast(ImagePreviewActivity.this, ImagePreviewActivity.this.getString(R.string.select_limit, selectLimit));
