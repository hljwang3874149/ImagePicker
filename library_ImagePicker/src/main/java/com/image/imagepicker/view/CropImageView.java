package com.image.imagepicker.view;
...
//                    bitmap.recycle();
     ...
     */
    private Bitmap makeCropBitmap(Bitmap bitmap, RectF focusRect, RectF imageMatrixRect, int expectWidth, int exceptHeight, boolean
            isSaveRectangle) {
     ...
     * 根据系统时间、前缀、后缀产生一个文件
     */
    private File createFile(@NonNull File folder, String prefix, String suffix) {
...
//        String file1 = prefix + "avatar"+ suffix;

//        File file = (new File(folder, file1));
//        if (file.exists()) {
//            if(file.delete()){
//                Log.e("deleta" ," delete true " + file1);
//                return new File(folder, file1);
//            }else{
//                Log.e("deleta" ," delete false " + filename);
...
//        }else{
    ...
    private void saveOutput(Bitmap croppedImage, Bitmap.CompressFormat outputFormat, File saveFile) {
        ...
        try {
            ...
            if (outputStream != null) croppedImage.compress(outputFormat, 80, outputStream);
